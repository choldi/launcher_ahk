...
runwait, taskkill /f /im msedge.exe,,
SetTitleMatchMode 2
;MsgBox ,,"Kodi", "Starting Seren",5
name_win:="Prime Video - Google Chrome"
run, "C:\Program Files (x86)\Google\Chrome\Application\chrome.exe"  https://www.primevideo.com -start-fullscreen
